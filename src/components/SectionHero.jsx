...
const SectionHero = () => {
    return (
        <div className='font-outfit bg-OffWhite py-12 px-10 w-screen flex justify-center'>
            <div className='flex justify-center items-center gap-6 w-[1200px]'>
                <div className='flex flex-col gap-4 flex-1 justify-center'>
                    <h3 className='text-lg text-GreenAll font-semibold leading-6'>De la planta a tu taza</h3>
