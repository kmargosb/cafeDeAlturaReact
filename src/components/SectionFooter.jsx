            ...
            <div className='flex flex-col gap-4 pt-[29px] pb-[38px] w-[1200px]'>
                <Link to="/" className='flex gap-2 items-center'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="25" viewBox="0 0 21 26" fill="none">
                        <g clip-path="url(#clip0_14771_150)">
                        ...
                        <defs>
                            <clipPath id="clip0_14771_150">
                                <rect width="20.5299" height="24.9292" fill="white" transform="translate(0.332031 0.535156)" />
                            </clipPath>
                        </defs>
                    </svg>
                </Link>
                            ...
                            text={
                                <div className='flex items-center gap-2 text-[14px] leading-[16px] font-semibold'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 25 24" fill="none">
                                        <path d="M3.95312 5C3.95312 3.89543 4.84856 3 5.95312 3H9.23237C9.6628 3 10.0449 3.27543 10.181 3.68377L11.6789 8.17721C11.8362 8.64932 11.6225 9.16531 11.1774 9.38787L8.92013 10.5165C10.0224 12.9612 11.9919 14.9308 14.4366 16.033L15.5653 13.7757C15.7878 13.3306 16.3038 13.1169 16.7759 13.2743L21.2694 14.7721C21.6777 14.9082 21.9531 15.2903 21.9531 15.7208V19C21.9531 20.1046 21.0577 21 19.9531 21H18.9531C10.6689 21 3.95312 14.2843 3.95312 6V5Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
